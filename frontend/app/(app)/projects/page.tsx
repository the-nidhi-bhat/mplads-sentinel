...
function ProjectsDirectory() {
  ...
  return (
    <section className="space-y-6">
      <div><h1 className="text-2xl font-bold text-[var(--text-primary)]">Projects</h1><p className="mt-1 text-sm text-[var(--text-muted)]">Browse tracked MPLADS projects and their audit priority scores.</p></div>
